...
def initialize_login_ui(root):
    ...
    load_images(root, "Picture1.png", "Picture1.png")

    ctk.CTkLabel(root, text="ID", font=("Helvetica", 16)).pack(pady=10)
    ...
    ctk.CTkOptionMenu(root, variable=role_var, values=["admin", "user"]).pack(pady=5)
...
def load_images(root, light_image_path, dark_image_path):
    try:
